...
reference_trajectory = pd.read_csv("reference_trajectory.csv", index_col='time')
imu = pd.read_csv("imu.csv", index_col='time')
...
df1 = pd.DataFrame(trajectory_error)
df1.to_csv('trajectory_error.csv')
